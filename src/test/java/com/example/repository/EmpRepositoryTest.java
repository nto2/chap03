...
public class EmpRepositoryTest {
	...
	public void findByEmpnoBetween() {
		...
		empRepository.findByEmpnoBetween(new BigInteger("1001"), new BigInteger("1012")).forEach(e -> {
			System.out.println(e);
		});
	...
	public void findByGenderOrderByEmpno() {
		empRepository.findByGenderOrderByEmpno(Gender.F).forEach(e-> {
			System.out.println(e);
		});
	}
	...
	public void findByGenderOrderByEmpnoDesc() {
		empRepository.findByGenderOrderByEmpnoDesc(Gender.F).forEach(e-> {
			System.out.println(e);
		});
	}

	//delete 는 가능，update는 불가능
	@Test
